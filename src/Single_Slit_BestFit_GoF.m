data = load('Single_Slit_100x_0.04mm_slow_Treated.txt'); % Load data into a variable
x_data = data(:, 1);
y_data = data(:, 2);
x_error = data(:, 3);
y_error = data(:, 4);

initial_guess = [0.3, 0, 80, 0, 0, 0]; % Initial parameter guesses
...
title('Single Slit Diffraction Intensity vs Position');
